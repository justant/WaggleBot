...
def test_plan_entries_contain_scene_idx():
    ...
    scenes = [
        ...
        _make_scene("img_text", ["본문 텍스트 1"], image_url="http://img/1.jpg"),
        _make_scene("text_only", ["줄1", "줄2"]),
        _make_scene("img_only", ["캡션"], image_url="http://img/2.jpg"),
...
def test_plan_entry_types_correct():
    ...
    scenes = [
        ...
        _make_scene("img_text", ["본문"], image_url="http://img/a.jpg"),
        _make_scene("outro", ["아웃트로"]),
    ]
    _, plan, _ = _scenes_to_plan_and_sentences(scenes)

    assert [e["type"] for e in plan] == ["intro", "img_text", "outro"]
...
def test_get_scene_by_scene_idx():
    ...
    scenes = [
        ...
        _make_scene("img_text", ["본문"], video_clip_path="/tmp/clip1.mp4"),
    ...
    entry = {"type": "img_text", "sent_idx": 1, "scene_idx": 1}
...
def test_get_scene_idx_fallback_to_text_match():
    ...
    entry = {"type": "img_text", "sent_idx": 1}
    result = _get_scene_for_entry(entry, sentences, scenes)
    assert result is scenes[1]
...
def test_roundtrip_plan_to_scene_with_video_clips():
    ...
    scenes = [
        ...
        _make_scene("img_text", ["본문1"], image_url="http://img/1.jpg", video_clip_path="/tmp/v1.mp4"),
